...
import in.rtapps.newtuto.R;
import in.rtapps.newtuto.shapes.Circle;
import in.rtapps.newtuto.shapes.RoundRect;
...
public final class TutoShowcase {
    ...
    public  Boolean FULLCLICKENABLE = true;
    ...
    public void setFullViewDismissClick(boolean dismiss)
    {
    ...
    public TutoShowcase show() {
        ...
        ViewCompat.animate(container)
                ...
                .start();
        final Boolean clickenable = this.FULLCLICKENABLE;
